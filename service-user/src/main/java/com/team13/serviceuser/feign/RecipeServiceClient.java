...
public interface RecipeServiceClient {
    ...
    List<MypageRecipeResponseDto> getRecipesByUserId(@RequestHeader("X-User-Id") Long userId);

    @GetMapping("/recipes/like/user")
    List<MypageRecipeResponseDto> getLikeRecipesByUserId(@RequestHeader("X-User-Id") Long userId);
}
